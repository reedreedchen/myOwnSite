...
function translate(){
	if(document.documentElement.lang=="en"){//traslate to traditional chinese
		...
		document.getElementById("ani2AlignTag").setAttribute('align','center');
		...
		document.getElementById("gallery").innerHTML = "展示中心";
		document.getElementById("animation").innerHTML = "完整動畫";
		document.getElementById("demoReelTitle").innerHTML = "2016年 作品剪輯";
		...
		document.getElementById("galleryTitle").innerHTML = "展示中心";
		...
		document.getElementById("scripting1").innerHTML = "居家護理模擬訓練";
		document.getElementById("gitHub").innerHTML = "] (GitHub 文件庫)";
		document.getElementById("3DCreation").innerHTML = "3D創作";
		document.getElementById("3DCreation1").innerHTML = "[實時演算-居家護理模擬計畫]<br/>5 張圖片";
		...
		document.getElementById("storytelling").innerHTML = "故事創作與分鏡圖";
		document.getElementById("storytelling1").innerHTML = "立方貓 (<i>Square Cat</i>)";
		document.getElementById("storytelling2").innerHTML = "埋葬獨角獸 (<i>The Buried Unicorn</i>)";
		document.getElementById("storytelling3").innerHTML = "天使心靈 (<i>Angel's Spirit</i>)";
		document.getElementById("storytelling4").innerHTML = "絕望的眼 (<i>Eye of Despair</i>)";
		document.getElementById("storytelling5").innerHTML = "落下的星星 (<i>The Falling Star</i>)";
		document.getElementById("other").innerHTML = "其它作品";
		document.getElementById("other1").innerHTML = "關卡設計-<i>Forsaken</i>";
		document.getElementById("other2").innerHTML = "資料圖表-<i>TWO</i>";
		document.getElementById("other3").innerHTML = "Flash 動畫與視覺設計-<i>SWSS</i>";
		document.getElementById("cleckAni").innerHTML = "*點選";
		document.getElementById("animation2").innerHTML = "完整動畫";
		document.getElementById("cleckAni3").innerHTML = " 觀看更多作品*";
		...
		document.getElementById("ani2AlignTag").setAttribute('align','left');
		...
		document.getElementById("demoReelTitle").innerHTML = "Demo Reel 2016";
		...
		document.getElementById("galleryTitle").innerHTML = "Gallery";
		...
		document.getElementById("scripting1").innerHTML = "<i>Home Heathcare Project</i>";
		document.getElementById("gitHub").innerHTML = "] (GitHub Directory)";
		...
		document.getElementById("storytelling").innerHTML = "Storytelling & Storyboards";
		document.getElementById("storytelling1").innerHTML = "<i>Square Cat</i>";
		document.getElementById("storytelling2").innerHTML = "<i>The Buried Unicorn</i>";
		document.getElementById("storytelling3").innerHTML = "<i>Angel's Spirit</i>";
		document.getElementById("storytelling4").innerHTML = "<i>Eye of Despair</i>";
		document.getElementById("storytelling5").innerHTML = "<i>The Falling Star</i>";
		document.getElementById("other").innerHTML = "Other";
		document.getElementById("cleckAni").innerHTML = "*Check the";
		document.getElementById("animation2").innerHTML ="animation";
		document.getElementById("cleckAni3").innerHTML = " tabs for more of my work not listed here.*";
		document.getElementById("other1").innerHTML = "Level Design-<i>Forsaken</i>";
		document.getElementById("other2").innerHTML = "Data Visualization-<i>TWO</i>";
		document.getElementById("other3").innerHTML = "Flash, Graphic Design-<i>SWSS</i>";
...
{ 
	...
	else if(document.title=="bio | reneechenwork.com")//bio
	{
		if(currentLang == "en")
		{
			document.getElementById("bioDarkTitle").innerHTML = "Bio";
		...
		{
			document.getElementById("bioDarkTitle").innerHTML = "個人簡介";
			...
			document.getElementById("p3").innerHTML = "我的目標是整合科技與人性，作有深度的說故事人和藝術家。我從我的情感和日常生活中的掙扎中找靈感，並將其與技術整合，在科技與人文兩方面尋找問題與答案。每個人都有難以表達苦痛，而我用互動媒體整合這些心情，讓遊戲不僅帶來娛樂，更是表現黑色幽默與傷感的工具。我也是一個中輕度玩家，以下我列出一部份喜歡的遊戲：塊魂、模擬市民3、魔獸世界、奇異人生、疆屍毀滅工程、與上古捲軸V： 天際。";
