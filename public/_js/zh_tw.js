...
function translate(){
	if(document.documentElement.lang=="en"){//traslate to traditional chinese
		...
		document.getElementById("clickPreview").innerHTML = "*點選連結或預覽圖有更多細節。";
		...
		document.getElementById("storytelling1").innerHTML = "立方貓 (<i>Square Cat</i>) - 1 張圖片";
		document.getElementById("storytelling2").innerHTML = "埋葬獨角獸 (<i>The Buried Unicorn</i>) - 3張圖片";
		document.getElementById("storytelling3").innerHTML = "天使心靈 (<i>Angel's Spirit</i>) - 3張圖片";
		document.getElementById("storytelling4").innerHTML = "絕望的眼 (<i>Eye of Despair</i>) - 2 張圖片";
		document.getElementById("storytelling5").innerHTML = "落下的星星 (<i>The Falling Star</i>) - 1 張圖片";
		document.getElementById("other").innerHTML = "設計 - 其它";
		...
		document.getElementById("clickPreview").innerHTML = "*Click on the links or the images for details.";
		...
		document.getElementById("storytelling1").innerHTML = "<i>Square Cat</i> - 1 image";
		document.getElementById("storytelling2").innerHTML = "<i>The Buried Unicorn</i> - 3 images";
		document.getElementById("storytelling3").innerHTML = "<i>Angel's Spirit</i> - 3 images";
		document.getElementById("storytelling4").innerHTML = "<i>Eye of Despair</i> - 2 images";
		document.getElementById("storytelling5").innerHTML = "<i>The Falling Star</i> - 1 image";
		document.getElementById("other").innerHTML = "Design - Other";
		document.getElementById("cleckAni").innerHTML = "*Check the";
		document.getElementById("animation2").innerHTML ="animation";
		document.getElementById("cleckAni3").innerHTML = " tab for more.";
